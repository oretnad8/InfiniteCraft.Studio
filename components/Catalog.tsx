...
const categories = [
  ...
  { 
    name: 'Marcos', 
    emoji: '🖼️', 
    description: 'Marcos decorativos únicos',
    slug: 'marcos',
  ...
  { 
    name: 'Lámparas', 
    emoji: '💡', 
    description: 'Iluminación artística personalizada',
    slug: 'lamparas',
              ...
              >
                <div className="relative overflow-hidden">
                  <img 
                    src={category.image}
                    alt={category.name}
                    className={`w-full h-36 sm:h-48 object-cover transition-transform duration-300 ${
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="text-red-600 font-semibold flex items-center text-sm sm:text-base">
                    Ver productos <i className="ri-arrow-right-line ml-2"></i>
                  </div>
                </div>
              </div>
            </Link>
